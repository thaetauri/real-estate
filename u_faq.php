    ...
    <div id="main_content"> 
        ...
        <div class="title">FAQ</div> 
         <div class="contact_tab">	
					...
					<p style="font-size:14px;" align="justify"><b> Bagaimana BUT Estate melindungi privasi Kami?</b></p><br />
                    <p style="font-size:14px;" align="justify">
					Kami paham bahwa keamanan dan privasi penting artinya bagi Anda – dan penting bagi kami juga.
					Prioritas kami adalah memberikan keamanan yang kuat dan membuat Anda yakin bahwa informasi aman dan dapat 
					diakses saat dibutuhkan. Kami terus berupaya untuk memastikan keamanan yang kuat, melindungi privasi Anda, 
					dan membuat BUT jadi lebih efektif dan efisien untuk Anda.</p><br />
					<p style="font-size:14px;" align="justify">Kami menghabiskan ratusan juta dolar setiap tahun untuk keamanan, 
					dan mempekerjakan ahli keamanan data yang 
					terkenal di dunia untuk menjaga informasi Anda tetap aman.
					Kami juga membuat alat keamanan dan privasi yang mudah digunakan, verifikasi 2 langkah, dan Pengelola 
					Preferensi Iklan. Jadi saat Anda berbagi informasi dengan BUT,
					Anda dapat mengendalikannya.</p>
					
					<br /> <br />
					<p style="font-size:14px;" align="justify">
						<b>Bagaimana Cara saya menghubungi BUT apabila ada keluhan?</b>
					</p><br />
					
                    <p style="font-size:14px;" align="justify">
						Anda dapat menghubungi kami melalui layanan <b>Contact Us</b> yang telah kami sediakan pada menu utama di atas.
					</p>
                    </div>
                    ...
                    <br /><br /><br /><br /><br />
                    <img src="images/logo_but.png" width="300" height="200" border="0" />
                    </div>
